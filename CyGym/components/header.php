<header>
    ...
    <nav class='navigation-card'>
        <a href='../index.php' alt='home' class='tab'>
        ...
        <a href='#' alt='search' class='tab'>
            <svg width='101' height='114' viewBox='0 0 101 114' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <circle cx='46.1726' cy='46.1727' r='29.5497' transform='rotate(36.0692 46.1726 46.1727)' stroke='black'
